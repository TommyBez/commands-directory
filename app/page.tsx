		...
		<div className="min-h-screen flex flex-col">
					...
					<div className="container mx-auto px-4">
						<div className="max-w-4xl mx-auto text-center space-y-8">
							...
							<p className="text-xl text-muted-foreground max-w-2xl mx-auto">
								Discover, search, and learn keyboard-driven commands to boost your
								productivity. Find the perfect shortcut for every task.
							</p>
						<div className="flex flex-col items-center gap-4">
							<Suspense fallback={<div className="w-full max-w-2xl h-12 bg-muted animate-pulse rounded-md" />}>
								<SearchBar />
							</Suspense>
					...
					<div className="grid md:grid-cols-3 gap-6 max-w-5xl mx-auto">
						...
						<Card>
							<CardHeader>
								...
								<CardDescription>
									Browse by category and tags to find reusable commands for your workflow
								</CardDescription>
							</CardHeader>
						</Card>
					</div>
						...
						<div className="max-w-5xl mx-auto">
							...
							<div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4">
								{featuredCategories.map((category) => (
									<Link key={category.id} href={`/commands?category=${category.slug}`}>
			...
			<footer className="border-t py-8">
				<div className="container mx-auto px-4 text-center text-sm text-muted-foreground">
					<p>© 2025 Cursor Commands Explorer. Built with Next.js and Drizzle.</p>
				</div>
			</footer>
		</div>
	);
